...
model_deployment = os.getenv("MODEL_DEPLOYMENT_NAME") or ""

if not project_endpoint:
    raise ValueError("PROJECT_ENDPOINT is not set. Check your .env file.")
if not model_deployment:
    raise ValueError("MODEL_DEPLOYMENT_NAME is not set. Check your .env file.")
        ...
        while True:
            ...
            for item in response.output:
                if item.type == "function_call":
                    ...
                    tool_text = output.content[0].text if getattr(output, "content", None) else str(output)
                    input_list.append(
                        FunctionCallOutput(
